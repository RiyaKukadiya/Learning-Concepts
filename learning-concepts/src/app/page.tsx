...
const app = () => {
  return (
    <main className="flex flex-col items-center min-h-screen bg-gray-50">
      ...
      {/* <div className="border-8 border-black flex items-center justify-center m-5 w-96">
          <img src="/sunset.jpg" className="" />
        </div>
        // Change object-* here: object-contain, object-fill, object-none, object-scale-down */}
      <div className="grid grid-cols-3 text-center">
        ...
        <div className="border-8 border-black flex items-center justify-center m-5 w-96 h-64">
          <img src="/sunset.jpg" className="w-60 h-60 object-scale-down" alt="Sunset" />
        </div>
        </div>
        <div>
